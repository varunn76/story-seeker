...
export const MacWindow = ({ children }: { children: React.ReactNode }) => (
  <motion.div
    ...
    className="w-full max-w-2xl bg-zinc-950/40 backdrop-blur-3xl rounded-3xl sm:rounded-[40px] overflow-hidden shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5)] border border-white/10 flex flex-col mx-auto relative group isolate hover:border-white/20 transition-colors duration-500"
  >
    <div className="h-10 bg-white/5 flex items-center px-4 sm:px-6 gap-3 border-b border-white/5">
    ...
    <div className="flex-1 relative overflow-visible p-3 sm:p-6 md:p-7 flex flex-col gap-4 sm:gap-6 md:gap-7">
      {children}
    </div>
