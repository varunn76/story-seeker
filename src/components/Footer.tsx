      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8 text-center md:text-left">
        <div className="flex flex-col gap-4 items-center md:items-start">
          ...
          <p className="text-text-secondary text-sm max-w-[240px] leading-relaxed">
            Find movies, shows, and stories from memory — not by name. Describe
            what you recall, and discover it instantly.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-4 items-center md:items-end">
          <div className="flex items-center gap-3">
            <Link
              href="#"
              className="p-2 bg-surface border border-white/5 rounded-full hover:border-primary/50 hover:bg-surface-hover transition-all"
            >
